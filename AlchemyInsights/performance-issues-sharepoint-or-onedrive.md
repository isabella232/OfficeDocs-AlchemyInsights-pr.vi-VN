...
SharePoint hoặc OneDrive có thể chậm, không truy nhập được hoặc không khả dụng vì nhiều lý do:
...
- Nếu bạn gặp phải hiệu suất chậm với một trang web **cổ điển** hoặc SharePoint trang, sử dụng [công cụ chẩn đoán trang](https://aka.ms/perftool) để phân tích các trang.
