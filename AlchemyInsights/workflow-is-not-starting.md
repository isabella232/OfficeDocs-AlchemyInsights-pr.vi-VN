...
- SharePoint 2010 quy trình công việc trì hoãn ngày bắt đầu.
    ...
    Ngoài ra, nếu các lịch sử công việc của bạn đã phát triển lớn, bạn có thể muốn xoá các khoản mục hoặc tạo ra một danh sách lịch sử mới.
...
Bạn muốn thử Micrsoft chảy trong SharePoint Online?
