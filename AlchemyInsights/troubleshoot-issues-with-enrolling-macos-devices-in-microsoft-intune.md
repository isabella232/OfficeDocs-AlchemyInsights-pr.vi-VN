...
3. [Tìm hiểu làm thế nào để ghi danh macOS thiết bị trong Microsoft dành](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Kiểm tra người dùng cuối hướng dẫn để đăng ký thiết bị macOS trong Microsoft Intune](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
