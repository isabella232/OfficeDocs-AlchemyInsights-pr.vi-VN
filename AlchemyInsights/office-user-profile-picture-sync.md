...
ms.locfileid: "35132219"
---
# <a name="sync-a-users-profile-picture"></a>Đồng bộ ảnh tiểu sử của người dùng

Bạn có thể thêm hoặc thay đổi ảnh tiểu sử của bạn trong Office 365 từ Office.com, hoặc trong khi sử dụng ứng dụng Office 365 trên máy tính của bạn hoặc trong một trình duyệt trên điện thoại của bạn. Hình ảnh của bạn sẽ xuất hiện ở khắp mọi nơi có một cấu hình ảnh vòng tròn trong Office 365.

Để thêm ảnh tiểu sử của bạn vào Office 365 Beta dành cho doanh nghiệp

- Tìm thấy một bức ảnh mà bạn muốn sử dụng và lưu trữ nó trên máy tính của bạn, OneDrive hoặc vị trí khác, bạn có thể nhận được.
