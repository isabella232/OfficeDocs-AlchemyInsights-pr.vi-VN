...
---
# <a name="cancel-visio-subscription"></a>Hủy bỏ đăng ký Visio

Người quản trị có thể hủy bỏ đăng ký Visio cho tổ chức của họ trong Trung tâm quản trị Microsoft 365.

1. Đi tới **thanh toán hóa** \> trang [sản phẩm của bạn](https://go.microsoft.com/fwlink/p/?linkid=842054) .
2. Trên tab **sản phẩm** , hãy tìm đăng ký Visio mà bạn muốn hủy bỏ. Chọn **hành động khác** (ba chấm), rồi chọn **hủy bỏ đăng ký**.
