...
ms.locfileid: "33828523"
---
# <a name="problems-signing-in-to-microsoft-skype-for-business"></a>Vấn đề đăng nhập vào Microsoft Skype cho doanh nghiệp

Tải về và sử dụng các [hỗ trợ và phục hồi chương trình hỗ trợ (SaRA)](https://aka.ms/SaRA-SkypeForBusinessSignIn). Công cụ này có thể giúp bạn tự động chẩn đoán và sửa chữa một loạt các vấn đề có liên quan để đăng nhập vào Skype cho doanh nghiệp.