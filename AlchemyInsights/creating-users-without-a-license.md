...
ms.locfileid: "44505817"
---
# <a name="create-mailboxes-that-dont-require-licenses"></a>Tạo hộp thư không yêu cầu giấy phép

- Nếu bạn cần một địa chỉ email nhóm cho nhiều người, xem [tạo hộp thư dùng chung](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox).
