...
- [Khách hàng truy cập vào các nguyên tắc trong trao đổi trực tuyến](https://technet.microsoft.com/library/mt842508.aspx) (tìm kiếm các giao thức **RemotePowerShell** ) 
    
    **Lưu ý**: khi được mô tả trong các chủ đề, hãy cẩn thận không để chặn quyền truy cập vào Exchange Online PowerShell cho quản trị viên.
