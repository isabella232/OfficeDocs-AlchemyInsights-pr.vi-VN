...
1. Trong Trung tâm quản trị, đi tới **người dùng > người dùng đang hoạt động**.
...
Là quản trị viên, nếu một trong những người dùng của bạn bị hạn chế gửi email, bạn có thể [bỏ chặn tài khoản](https://docs.microsoft.com/microsoft-365/security/office-365-security/removing-user-from-restricted-users-portal-after-spam) **mà không cần mở một trường hợp hỗ trợ**. Người dùng sẽ có thể gửi email trong vòng một giờ sau khi loại bỏ các hạn chế.
