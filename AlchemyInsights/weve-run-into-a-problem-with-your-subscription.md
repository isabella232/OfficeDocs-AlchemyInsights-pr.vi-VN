...
---
# <a name="fixing-the-microsoft-365-apps-weve-run-into-a-problem-with-your-subscription-message"></a>Khắc phục các ứng dụng Microsoft 365 "chúng tôi đã chạy vào một vấn đề với đăng ký của bạn" thông báo
...
- [Loại bỏ](https://docs.microsoft.com/microsoft-365/admin/manage/remove-licenses-from-users) và [gán giấy phép](https://docs.microsoft.com/microsoft-365/admin/manage/assign-licenses-to-users) cho người dùng bị ảnh hưởng.
