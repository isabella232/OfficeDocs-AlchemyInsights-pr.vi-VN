---
title: Hình ảnh nội tuyến Kiểm tra Alchemy
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a>Truy nhập Trang Miền

Để truy nhập trang miền, chỉ cần bấm vào biểu tượng này bên dưới:
...
Sau đó bạn có thể thêm, sửa đổi hoặc loại bỏ miền của mình.
