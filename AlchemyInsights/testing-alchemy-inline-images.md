...
ms.locfileid: "36507185"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="22438-102">Truy cập vào trang miền</span><span class="sxs-lookup"><span data-stu-id="22438-102">Access the Domains Page</span></span>

<span data-ttu-id="22438-103">Để truy cập vào các trang miền, chỉ cần nhấp vào biểu tượng dưới đây:</span><span class="sxs-lookup"><span data-stu-id="22438-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="22438-104">Sau đó bạn có thể thêm, sửa đổi hoặc loại bỏ các tên miền của bạn.</span><span class="sxs-lookup"><span data-stu-id="22438-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="22438-105">Để biết thêm thông tin, hãy xem các [hỏi đáp tên miền.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="22438-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
