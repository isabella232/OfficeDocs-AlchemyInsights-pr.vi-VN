...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="e70cf-102">Truy cập trang miền</span><span class="sxs-lookup"><span data-stu-id="e70cf-102">Access the Domains Page</span></span>

<span data-ttu-id="e70cf-103">Để truy cập trang miền, chỉ cần nhấp vào biểu tượng dưới đây:</span><span class="sxs-lookup"><span data-stu-id="e70cf-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="e70cf-104">Sau đó, bạn có thể thêm, sửa đổi hoặc xóa tên miền của mình.</span><span class="sxs-lookup"><span data-stu-id="e70cf-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="e70cf-105">Để biết thêm thông tin, hãy xem [câu hỏi thường gặp về miền.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="e70cf-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
