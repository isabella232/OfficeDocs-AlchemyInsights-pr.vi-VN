...
Chúng tôi khuyên bạn sử dụng [Outlook tiếp tục yêu cầu mật khẩu của tôi](https://aka.ms/SaRA-OutlookPwdPrompt-Alchemy) chẩn đoán trên máy bị ảnh hưởng để khắc phục sự cố trong đó Outlook liên tục nhắc mật khẩu. Chẩn đoán [SaRA](https://diagnostics.office.com/#/) này không tự động kiểm tra và trả về các giải pháp có thể để bạn sử dụng đến địa chỉ bất kỳ vấn đề phát hiện.
