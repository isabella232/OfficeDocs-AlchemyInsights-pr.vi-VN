...
Kiểm tra các cài đặt SharePoint và OneDrive chia sẻ bên ngoài cho tổ chức của bạn.

- [Admin](https://admin.microsoft.com/AdminPortal/Home#/homepage">https://admin.microsoft.com/)
- Chọn quản trị viên
- Chọn Trung tâm quản trị SharePoint
- Chọn chia sẻ để xem bên ngoài cài đặt chia sẻ
