...
---
# <a name="import-contacts"></a>Nhập liên hệ

Trước khi nhập liên hệ vào Outlook.com, bạn sẽ cần xuất chúng từ nhà cung cấp email khác của bạn dưới dạng tệp. CSV. Sau đó, hãy làm theo các hướng dẫn dưới đây.
...
.
2. Ở đầu trang, chọn **quản lý** \> **nhập liên hệ**.
3. Chọn **duyệt**, dẫn hướng đến thư mục mà bạn đã lưu các liên hệ đã xuất của mình, rồi chọn **mở**.

Để tìm hiểu thêm, hãy xem [nhập liên hệ vào Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
