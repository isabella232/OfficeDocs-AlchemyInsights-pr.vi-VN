...
- Trong Trung tâm quản trị mới SharePoint, trên trang web, nhấp vào **tạo**. 
    
 **Lưu ý:** Bạn không thể tạo một trang web mới có cùng một URL với một trang web hiện có. 
  
Để biết thêm chi tiết về việc tạo ra một trang web, hãy xem [tạo một trang web](https://go.microsoft.com/fwlink/?linkid=866295).
