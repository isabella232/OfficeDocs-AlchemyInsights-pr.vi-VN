...
Nếu bạn muốn mọi người trong tổ chức của bạn để có thể đăng nhập và sử dụng SharePoint và OneDrive, bạn cần phải thêm tài khoản cho họ và đảm bảo rằng họ có một giấy phép cho phép họ truy cập SharePoint và OneDrive. Cách dễ nhất để thêm người dùng là ở trung tâm quản trị Microsoft 365.
  
1. Đi đến [trang Trung tâm quản trị Microsoft 365 người dùng hoạt động](https://portal.office.com/adminportal/home#/users), và sau đó nhấp vào **Thêm người dùng**.
