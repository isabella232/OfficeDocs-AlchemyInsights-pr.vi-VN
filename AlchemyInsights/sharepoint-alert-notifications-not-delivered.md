...
ms.locfileid: "35840610"
---
# <a name="sharepoint-alert-notifications-not-delivered"></a>SharePoint báo không gửi được 

Trước tiên, xác định nếu tất cả cảnh báo không được chuyển giao, hoặc nếu một cảnh báo cá nhân từ một tập tin cụ thể hoặc thư viện không được chuyển giao.
...
- **Cảnh báo khắc phục**: để biết thêm chi tiết về khắc phục sự cố các thông báo, thấy [người dùng không nhận được thông báo cảnh báo SharePoint Online](https://support.office.com/article/users-don-t-receive-sharepoint-online-alert-notifications-14fc22dd-e873-482c-844d-f67ad41313f1).
