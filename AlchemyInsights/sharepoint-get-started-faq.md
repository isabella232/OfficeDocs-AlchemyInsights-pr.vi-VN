...
- **Bắt đầu**: sử dụng [SharePoint Look Book](https://lookbook.microsoft.com/assets/SharePoint_lookbook_2019.pdf) để tạo một mạng nội bộ đẹp, mạnh mẽ kết nối nơi làm việc. Xem [ví dụ](https://lookbook.microsoft.com/) và nhận [hướng dẫn thiết kế](https://spdesign.azurewebsites.net/). Xem giới thiệu về [SharePoint trực tuyến](https://docs.microsoft.com/sharepoint/introduction) để có một tổng quát về SharePoint Online.
...
**Lưu ý:** Để có câu trả lời cụ thể hơn về vấn đề SharePoint, hãy tóm tắt lại câu hỏi của bạn và bao gồm bất kỳ lỗi nào bạn đang xem hoặc các tính năng bạn đang sử dụng.