...
- Sử dụng [Cổng thông tin khắc phục sự cố dành](https://aka.ms/intunetroubleshooting) để chẩn đoán và giải quyết chung đăng ký thất bại. Xem lại [tài liệu này](https://docs.microsoft.com/en-us/intune/help-desk-operators) cho biết thêm chi tiết. 
