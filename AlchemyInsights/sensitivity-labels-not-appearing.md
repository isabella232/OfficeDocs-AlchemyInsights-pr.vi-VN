...
Độ nhạy nhãn cho phép bạn để phân loại và bảo vệ nội dung nhạy cảm của bạn. Để tìm hiểu thêm về tính năng này, hãy xem [tổng quan về độ nhạy nhãn](https://docs.microsoft.com/office365/securitycompliance/sensitivity-labels).
...
Để biết thêm chi tiết về các vấn đề, xem [các vấn đề với độ nhạy nhãn đã biết](https://support.office.com/article/known-issues-with-sensitivity-labels-in-office-b169d687-2bbd-4e21-a440-7da1b2743edc?ui=en-US&rs=en-US&ad=US).