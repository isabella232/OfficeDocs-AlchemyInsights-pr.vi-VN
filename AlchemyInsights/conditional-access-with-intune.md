...
- [Có điều kiện tiếp cận thực tiễn tốt nhất](https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/best-practices)
    
- [Bắt đầu với điều kiện truy cập](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-conditional-access-azure-portal-get-started)
